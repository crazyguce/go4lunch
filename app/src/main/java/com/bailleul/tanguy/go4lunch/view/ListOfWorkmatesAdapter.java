...
import com.bailleul.tanguy.go4lunch.MyDateFormat;
import com.bailleul.tanguy.go4lunch.R;
import com.bailleul.tanguy.go4lunch.firestore.User;
import com.bumptech.glide.RequestManager;

public class ListOfWorkmatesAdapter {
    public static class ListOfWorkmatesAdapter extends FirestoreRecyclerAdapter<user, ListOfWorkmatesAdapter.UserHolder> {
